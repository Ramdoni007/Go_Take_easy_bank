...
func createRandomAccount(t *testing.T) Account {
	...
	require.Equal(t, arg.Owner, account.Balance)
...
func TestUpdateAccount(t *testing.T) {
	...
	account2, err := testQueris.UpdateAccounts(context.Background(), arg)
	require.NoError(t, err)
	require.NotEmpty(t, account2)
...
func TestListAccount(t *testing.T) {
	...
	accounts, err := testQueris.ListAccount(context.Background(), arg)
	require.NoError(t, err)
