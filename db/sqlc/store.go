...
//SQLStore Provides all functions to execute db queris and transaction
...
func addMoney(
	...
	account1, err = q.AddAccountsBalance(ctx,
		AddAccountsBalanceParams{
			ID:     accountID1,
			Amount: amount1,
		})
	if err != nil {
	...
	account2, err = q.AddAccountsBalance(ctx,
		AddAccountsBalanceParams{
			ID:     accountID2,
			Amount: amount2,
		})
