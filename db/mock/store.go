...
// Source: github.com/ramdoni007/Take_Easy_Bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TranferTx(arg0 context.Context, arg1 db.TransferTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) TranferTx(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
